...
const STANDARD_TERMS = [
  ...
  ['Agreement', 'Payment of this proposal constitutes acceptance of these terms and authorizes Bridgeville Bark & Stroll LLC to perform the services and access the property as described above.'],
];
...
<div class="inv">
  ...
  <div class="bd">
    ...
    ${termsHtml}
    <div style="margin-top:16px;padding-top:10px;border-top:1px solid var(--border);font-size:9px;color:var(--text-light);text-align:center;letter-spacing:0.3px;">Bridgeville Bark &amp; Stroll LLC &middot; a Pennsylvania limited liability company &middot; Bridgeville, PA &middot; (412) 992-1480 &middot; barkstroll.com</div>
  </div>
</div></body></html>`;
}
